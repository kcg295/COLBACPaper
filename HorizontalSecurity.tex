...
\title{FIRST DRAFT: Shifting Cybersecurity from Hierarchical to Horizontal designs}
...
\renewcommand{\shortauthors}{Gallagher and Feldman}
...
\keywords{security, democracy, activism, horizontality, distributed systems, authorization, access contrl}
