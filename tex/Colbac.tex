...
design were to provide flexibile and dynamic horizontality, and to provide
...
\textit{which} invidivual has that power, meaning that any single vote from any
user is capable of authorizing an action. This is far from a dictatorial
strucutre, in which all power is held only by one individual or a small set of
individuals.

This design does allow for many different expressions of horizontal structures,
however. For example, because of the existance of delegation Tokens which expire,
...
how the elected invidivudal is performing their duties, our solution allows for
...
a full consensus based approach, a supermajority approach, a majority approach,
...
arbitrary write in the Immuatble Sphere, transparency of the system is
...
referrendums is impossible to create using COLBAC, since the right to petition
