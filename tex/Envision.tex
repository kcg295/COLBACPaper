...
system may still be useful to inspire future horizontal system designs. In the case of cryptocurrencies, the competitive design tends to centralize the network over time.
...
meant to be horizontal by design is the PGP Web of Trust (WoT) design. This ecosystem attempts to allow entities to authenticate (i.e., tie public key
